        ...
        <div className="w-full gap-4 mb-4 flex items-center justify-end">
          ...
          <div>
            <div className="flex items-center pl-4 rounded border border-gray-200 dark:border-gray-700">
              ...
              <label for="bordered-checkbox-2" className="py-4 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300 pr-2">เสร็จสมบูรณ์</label>
            </div>
          </div>
          <div>
            <button
                    ...
                    <div className="relative p-6 flex-auto">
                      ...
                      <form className="w-full max-w-lg">
                        <div className="flex flex-wrap -mx-3 mb-6">
                          <div className="w-full md:w-2/2 px-3 mb-6" onClick={() => setShowModal2(true)}>
